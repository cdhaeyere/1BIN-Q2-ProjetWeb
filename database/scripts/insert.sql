INSERT INTO users(first_name, last_name, email, password, is_admin) VALUES('Corentin', 'Dhaeyere', 'corentin.dhaeyere@student.vinci.be', '$2b$10$vjhEQfESX5FGkVv9A05lrOj07Kf49Y/L280rN848AzLW7kWCnnRnu', true);
INSERT INTO users(first_name, last_name, email, password, is_admin) VALUES('Nicolas', 'Heymans', 'nicolas.heymans@student.vinci.be', '$2b$10$5UQqBylUcjX6u2nqk1Ny9er4nxi38KTx11Pnn/nKcBR9vTPJRIVQe', true);
